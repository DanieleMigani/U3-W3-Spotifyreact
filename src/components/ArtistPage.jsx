...
const ArtistPage = (props) => {
  ...
  return (
    <Container className="col-12 col-md-9 offset-md-3 HomePage">
      ...
      <Row className="row">
        <div className="col-12 col-md-10 col-lg-10 mt-5">
          {seeArtist?.map((el) => {
            return (
              <div key={el.id}>
                <h2 className="titleHome">{el.artist.name}</h2>
          ...
          <div className="d-flex justify-content-center" id="button-container">
            <Button
              variant="success"
              className="btn btn-success me-3 HomeButton"
              id="playButton"
            >
              PLAY
            </Button>
            <Button
              className="btn btn-outline-light ms-3 HomeButton"
              id="followButton"
            >
              FOLLOW
            </Button>
